...
public interface IUserService
{
    ...
    /// </returns>
    Task<PollsPage> GetPollsAsync(PollsPagePaginationParameters parameters, string userId);
    ...
    /// If user does not exist, an empty page is returned.
    /// </returns>
    Task<PollsPage> GetFavoritePollsAsync(PollsPagePaginationParameters parameters, string userId);
}
